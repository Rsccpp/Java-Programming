...
// // System.out.println("Circle class data: x = " + x); // non-static variable
// x cannot be referenced from a static context

// // if x is static means it is global variable
// System.out.println("Circle class data: x = " + x); // Circle class data: x =
// 50.0
// System.out.println("Box class data: x = " + b.x); // Box class data: x = 10.0
// System.out.println("Area of Box: x = " + b.area()); // Area of Box: x =
// 1300.0
// System.out.println("Circle class data: x = " + c.x); // Circle class data: x
// = 0.0
// System.out.println("Area of Circle: x = " + c.area()); // Area of Circle: x =
// 75.0
// }
...
// 1. Instance Variales -- Variables declare without static keywords inside
// class.
// 2. Class Variables -- Variables declare with static keywords. It acts as
// global variable.
...
// pa.display();
// System.out.println("Is the points {1,2} inside the circle with radius 2 : " +
// a.isInside(pa));

// chp5 b = new chp5(1.0);
// Point pb = new Point(3.0, 3.0);
// pb.display();
// System.out.println("Is the points {3, 3} inside the circle with radius 1 : "
// + b.isInside(pb));
// }
// }
...
// public class Practice {
// public static void main (String[] args){
// int result = MathUtil.square(8); // Method can be called without creating
// object
...
// 4. Static class(Nested Class) -- static nested class does not depend on outer
// instance
...
// 3. Calculation of GCD (Greachp5 common divisor)
// public class chp5 {
// static int m, n;
...
// System.out.println("GCD of (" + x.m + ", " + x.n + ") " + "is " + x.gcd(x.m,
// x.n));
// }
// }
