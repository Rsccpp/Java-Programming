...
public class chp1 { // File name
    ...
    public static void main(String[] args) {
        ...
        // ParseInt Method of Integer class == Convert string to number
        // String str = "123";
        ...
        // 1. Take an array of Strings input from user & find the cummulative(combined)
        ...
        // 2. Input a string from the user . Create a new string called 'result' in
        // which you wil replace the letter 'e' in the original string with letter 'i'.
        ...
        // **************** StringBuilder -- Use to make String mutable *****

        // public class chp1 {

        // public static void main(String[] args) {
        // // Declaration
        // StringBuilder sb = new StringBuilder("Java Journey");
        ...
        // // Delete character from some index
        // sb.delete(0, 1);
        // System.out.println(sb);

        // // Append a char -- Means to add something at the end
        // sb.append('!');
        // System.out.println(sb);
        ...
        // System.out.println("Befor Reverse String: " + sb);
...
// o/p:
// Befor Reverse String: Hello World
// After Reverse String: dlroW olleH